    ...
    return (
        ...
        <div className="kit_card_title">
            ...
            <div className="column">
                ...
                <img className="kit_image" src={props.kit.len.image} alt="len" className="stock_image_small"/>
            </div>
            <button id="remove_button" onClick={()=>props.handleDeleteKit(props.kit, props.id)}>Remove</button>
            </div>
        </div>
    )
}